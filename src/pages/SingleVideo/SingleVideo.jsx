...
const SingleVideo = () => {
	...
	return (
		<div className={theme =='light' ? css.containerWrapper : css.lightContainerWrapper}>
							...
							<div className={css.wrapper} key={index}>
								...
								<div className={css.statsWrapper}>
									...
									<div className={css.right}>
										...
										<div
											className={theme == 'light' ? css.more : css.lightMore}
										>
											<FiMoreHorizontal />
										</div>
									</div>
									...
									<div className={css.channelLeft}>
										...
										<div className={css.chRight}>
											...
											<div className={css.forBtnRight}>
												<p
													className={
														theme == 'light' ? css.desc : css.lightDesc
													}
												>
